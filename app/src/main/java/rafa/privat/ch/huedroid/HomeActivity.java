...
import rafa.privat.ch.huedroid.data.AccessPointListAdapter;
import rafa.privat.ch.huedroid.data.HueSharedPreferences;
...
public class HomeActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    public static final String TAG = "HueDroid";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (lastIpAddress !=null && !lastIpAddress.equals("")) {
            ...
            if (!phHueSDK.isAccessPointConnected(lastAccessPoint)) {
                PHWizardAlertDialog.getInstance().showProgressDialog(R.string.connecting, HomeActivity.this);
    ...
    private PHSDKListener listener = new PHSDKListener() {
        ...
        public void onAuthenticationRequired(PHAccessPoint accessPoint) {
            ...
            startActivity(new Intent(HomeActivity.this, PHPushlinkActivity.class));
        ...
        public void onError(int code, final String message) {
            ...
            if (code == PHHueError.NO_CONNECTION) {
                ...
                HomeActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        PHWizardAlertDialog.showErrorDialog(HomeActivity.this, message, R.string.btn_ok);
                    }
                });
    ...
    public void doBridgeSearch() {
        PHWizardAlertDialog.getInstance().showProgressDialog(R.string.search_progress, HomeActivity.this);
        PHBridgeSearchManager sm = (PHBridgeSearchManager) phHueSDK.getSDKService(PHHueSDK.SEARCH_BRIDGE);
    ...
    public void startMainActivity() {
        Intent intent = new Intent(getApplicationContext(), HueDroidActivity.class);
